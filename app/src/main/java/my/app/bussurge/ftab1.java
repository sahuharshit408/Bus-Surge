...
public class ftab1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        button = view.findViewById(R.id.Studentsignup);
        buttonEmail = view.findViewById(R.id.StudentEmailSignIn);

        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent user_signup = new Intent(getActivity(), user_signup.class);
...
////
        ...
        buttonEmail.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent Student_SignIn_Email = new Intent(getActivity(),Student_SignIn_Email.class);
                startActivity(Student_SignIn_Email);
